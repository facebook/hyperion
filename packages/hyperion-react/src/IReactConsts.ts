...
export const REACT_ELEMENT_TYPE: Sym = ReactIs.Element;// SymbolFor(0xeac7, 'react.element');
export const REACT_PORTAL_TYPE: Sym = ReactIs.Portal;// SymbolFor(0xeaca, 'react.portal');
export const REACT_FRAGMENT_TYPE: Sym = ReactIs.Fragment;// SymbolFor(0xeacb, 'react.fragment');
export const REACT_STRICT_MODE_TYPE: Sym = ReactIs.StrictMode;// SymbolFor(0xeacc, 'react.strict_mode');
export const REACT_PROFILER_TYPE: Sym = ReactIs.Profiler;// SymbolFor(0xead2, 'react.profiler');
export const REACT_PROVIDER_TYPE: Sym = ReactIs.ContextProvider;// SymbolFor(0xeacd, 'react.provider');
export const REACT_CONTEXT_TYPE: Sym = ReactIs.ContextConsumer;// SymbolFor(0xeace, 'react.context');
export const REACT_SERVER_CONTEXT_TYPE: Sym = SymbolFor(0xeae6, 'react.server_context');
export const REACT_FORWARD_REF_TYPE: Sym = ReactIs.ForwardRef;// SymbolFor(0xead0, 'react.forward_ref');
export const REACT_SUSPENSE_TYPE: Sym = SymbolFor(0xead1, 'react.suspense');
export const REACT_SUSPENSE_LIST_TYPE: Sym = ReactIs.Suspense;// SymbolFor(0xead8, 'react.suspense_list');
export const REACT_MEMO_TYPE: Sym = ReactIs.Memo;// SymbolFor(0xead3, 'react.memo');
export const REACT_LAZY_TYPE: Sym = ReactIs.Lazy;// SymbolFor(0xead4, 'react.lazy');
