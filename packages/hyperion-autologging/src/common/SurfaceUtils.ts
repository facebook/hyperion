...
export type GenericSurfaceEventData<TPlatformExtension> =
...
export type GenericSurfaceRenderer = (node: React.ReactNode) => React.ReactElement;

export type GenericSurfaceHOC<TProps> = (props: TProps, renderer?: GenericSurfaceRenderer) => GenericSurfaceRenderer;

export interface GenericSurfaceRenderers<TSurfaceComponent, TProps> {
  surfaceComponent: TSurfaceComponent;
  surfaceHOComponent: (props: TProps, renderer?: GenericSurfaceRenderer) => GenericSurfaceRenderer;
}

export type GenericChannelSurfaceEvent<TEventData> = Readonly<BaseChannelSurfaceEvent<TEventData>>;
...
export function createSurfaceDataRegistry<T>(): {
  registry: Map<string, T>;
  dataRegistry: SurfaceDataRegistry<T>;
} {
...
): (props: TProps, renderer?: GenericSurfaceRenderer) => GenericSurfaceRenderer {
